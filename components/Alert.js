  ...
  return (
    (successMessage || errorMessage) && (
      <motion.div
        ...
        className={`fixed top-12 sm:top-5 -ml-[165px] sm:-ml-[180px] left-1/2 flex justify-center text-sm sm:text-base items-center w-80 sm:w-96 py-3.5 sm:py-4 mb-4 z-[1000] ${
          errorMessage
