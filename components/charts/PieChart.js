        ...
        <div className='bg-white rounded-md shadow-md p-4 md:p-5'>
                        ...
                        <div className='bg-gray-50 p-2 rounded-lg'>
                            <Accordion allowsMultipleExpanded>
                                <AccordionItem key='1'>
                                    <AccordionHeading>
                                        <AccordionTrigger
                                            className="py-1.5 px-1 w-full flex items-center justify-between text-sm font-medium">
                                ...
                                <AccordionItem key='2'>
                                    ...
                                    <AccordionPanel>
                                        <AccordionBody>
                                            <div
                                                className='space-y-2 overflow-hidden bg-white p-2.5 rounded-lg shadow-sm'>
            ...
            <div className='grid grid-cols-1 items-center border-gray-200 border-t justify-between'>
                <div className='flex justify-between items-center pt-5'>
                    <Dropdown>
                        <Dropdown.Trigger>
                            <Button aria-label="Static Actions" variant="outline">
                                {pieChartPeriod}
                        ...
                        <Dropdown.Popover>
                            <Dropdown.Menu
                                ...
                                {dropdownPeriods.map((period) => (
                                    <Dropdown.Item key={period} id={period} textValue={period}>
                                        {period}
                                    </Dropdown.Item>
                                ))}
                            </Dropdown.Menu>
