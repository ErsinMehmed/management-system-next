  ...
  return (
    <div className='space-y-3.5 mt-2.5'>
        ...
        <div className='rounded-xl border border-blue-100 bg-blue-50/40 p-3.5 flex flex-col gap-3'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <span className='text-xs font-semibold text-[#0071f5]'>
                Втори продукт
              </span>
            </div>
            <button
            ...
            <div
              ...
              <div className='flex items-center gap-2.5'>
                <div
                  ...
                  <Icon
                    className={`w-3.5 h-3.5 ${isSelected ? color : "text-slate-400"}`}
                  />
                </div>
                <p
              ...
              <Switch
                ...
                onValueChange={(val) =>
                  handleFieldChange("contactMethod", val ? method : "")
                }
              />
            </div>
          );
      ...
      {isSuperAdmin && (
        <Input
          type='number'
          label='Хонорар дистрибутор (по избор)'
          value={data.distributorPayout || ""}
          onChange={(value) => handleFieldChange("distributorPayout", value)}
        />
      )}
