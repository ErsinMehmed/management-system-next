  ...
  return (
    <div
      ...
      <Image
        ...
        className='sm:h-56 xl:h-64 w-full object-cover object-center px-2.5'
      ...
      <div className='p-3.5 border-t border-slate-200'>
        <h2 className='mb-2 text-lg text-gray-700 font-semibold'>
          {productTitle(props.data)}
        </h2>

        <div className='mb-2 text-base text-gray-700 flex'>
          Наличност:{" "}
          <div className='bg-blue-400 text-white h-6 w-10 ml-2 mr-1 rounded center-element font-semibold shadow-md'>
        ...
        <div className='flex items-center'>
          <div className='mr-2 text-lg font-semibold text-gray-900'>
            {formatCurrency(props.data.price, 2)}
          </div>
        </div>
      </div>
    </div>
